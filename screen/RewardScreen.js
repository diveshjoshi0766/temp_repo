...
//     }, [comments])
//     const [currency_sign, setCurrency_sign] = useState("")
//     const fetchComments=async()=>{
//         const response=await axios(`${BASE_URL}/getReward/${parseInt(userInfo.Result && userInfo.Result.panelistID)}`);
//         currency_sign = response.data.panelistDetails.currency_sign
//         console.log(response.data.panelistDetails)
...
//                     </View>
//                     <View>
//                     <Text style={styles.modal_sub_heading}>Voucher Worth: {comments && comments.panelistDetails.currency_sign} {modal_data && modal_data.voucher_worth}</Text>
//                     </View>
//                     <View>
